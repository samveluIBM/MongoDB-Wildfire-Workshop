...
Using the mouse, click the MongoDB Compass icon on your workstation and select Add new Connection. 
 ...
 <img src="../assets/images/compconnect.png" width="551" height="116" >


In the URI field, enter:   mongodb://129.40.124.1xx:27017
Replace the ip address (such as 129.40.124.1xx)  with your Linux guest ip address   and press connect   
